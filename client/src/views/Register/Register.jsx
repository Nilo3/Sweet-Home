...
export function Register() {
  ...
  const handleGoogleRegiter = async () => {
    try {
      ...
      const usersInDb = await dispatch(getAllUsers());
      console.log(usersInDb);
      const isEmailRegistered = usersInDb.some((existingUser) => existingUser.email === userGoogle.email);
